...
import io.github.lz233.meizugravity.utils.WeatherUtil;
...
public class WeatherFragment extends Fragment {
    ...
    public WeatherFragment(SettingUtil settingUtil) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                new GetUtil().sendGet("https://api.caiyunapp.com/v2.5/Y2FpeXVuIGFuZHJpb2QgYXBp/"+settingUtil.getString("location")+"/weather.json", null, new GetUtil.GetCallback() {
                    @Override
